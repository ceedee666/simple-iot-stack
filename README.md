...
and data analysis scenarios. The following documents describe how
the IoT stack can be deployed using different cloud providers.

- [Deploy to Oracle cloud](./docs/oracle-cloud.md)
- [Deploy to Google cloud](./docs/google-cloud.md)
